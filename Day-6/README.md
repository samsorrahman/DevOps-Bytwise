...
1. Create a simple file and do `ls -ltr` to see the details of the files [refer to Notes](https://github.com/samsorrahman/DevOps-Bytwise/blob/main/Day-6/Linux_Basic_%26_FilePermissions.docx)
